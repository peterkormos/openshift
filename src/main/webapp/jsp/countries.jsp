...
<div class="input-caption-container">
	<select name='<%=request.getParameter("selectName")%>' id="country"
		...
		<optgroup label="<%=language.getString("highlighted.country")%>">
			...
			<option value='<%=language.getString("country.not.in.list")%>'><%=language.getString("country.not.in.list")%></option>
		</optgroup>
		<optgroup label="<%=language.getString("all.countries")%>">
			...
			<option value='Congo, the Democratic Republic of the Congo'>Congo,
			...
			<option value='Korea, Democratic People' s Republic OfKorea'>Korea,
				Democratic People's Republic Of Korea</option>
			<option value='Korea, Republic of Korea'>Korea, Republic of
				Korea</option>
			<option value='Kuwait'>Kuwait</option>
			<option value='Kyrgyzstan'>Kyrgyzstan</option>
			<option value='Lao People' s DemocraticRepublic'>Lao
